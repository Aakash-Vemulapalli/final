...
<div class="login">
<form name="f1"  method="post" action="http://localhost:8081/final/mainservlet" onsubmit="click()" >
<table >
<tr><td colspan="2"> Welcome <%=S %></td></tr>
<tr><td><input type="hidden" name="cb" id="cb" value="<%=S%>"></td></tr>
<tr><td><input type="submit" name="Up_event" value="user profile" id="b1" onclick="return click()"> </td></tr>
